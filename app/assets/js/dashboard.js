...
//					$scope.items.push(item);
	...
	.controller('NewsDaythemeEditCtrl', ['$scope', 'CONFIG', '$location', '$timeout', 'item', 'i18nNotifications', 'upload',
		function ($scope, CONFIG, $location, $timeout, item, i18nNotifications, upload) {
			...
			var tags = [
				{id: 1,  text: 'Вклады'},
				{id: 2,  text: 'Ипотечные кредиты'},
				{id: 3,  text: 'Потребительские кредиты'},
				{id: 4,  text: 'Кредитные карты'},
				{id: 5,  text: 'Дебетовые карты'},
				{id: 6,  text: 'Автокредиты'},
				{id: 7,  text: 'Кредитование малого и среднего бизнеса'},
				{id: 8,  text: 'Обслуживание юрлиц'},
				{id: 9,  text: 'Лизинг'},
				{id: 10, text: 'Дистанционное обслуживание'},
				{id: 11, text: 'Финансовая грамотность'},
				{id: 12, text: 'Реструктуризация кредитов'},
				{id: 13, text: 'БКИ'},
				{id: 14, text: 'Микрозаймы'},
				{id: 15, text: 'Страхование'}
			];
