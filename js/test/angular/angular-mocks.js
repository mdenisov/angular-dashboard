 ...
 * we don?ˆ™t want to send {@link https://developer.mozilla.org/en/xmlhttprequest XHR} or
...
function createHttpBackendMock($rootScope, $delegate, $browser) {
	 ...
	 *   request is handled.
	 *
	 *  - respond ?ˆ“ `{function([status,] data[, headers])|function(function(method, url, data, headers)}`
 ...
 *    an array containing response status (number), response data (string) and response headers
 *    (Object).
 *  - passThrough ?ˆ“ `{function()}` ?ˆ“ Any request matching a backend definition with `passThrough`
